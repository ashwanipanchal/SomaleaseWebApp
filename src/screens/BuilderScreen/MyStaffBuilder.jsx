...
import {  staff_list_builder } from '../../api/auth';
import { useNavigate } from 'react-router-dom';

const MyStaffBuilder = () => {
  ...
  const getStaff = async () => {
      ...
      setLoading(true)
    const res = await staff_list_builder({
      ...
      <div class="col-md-12 col-sm-12 col-md-12">
        ...
        <div class="sd-list-right">
          ...
          <div class="sd-list-right">
            ...
            <div onClick={() => navigate("/my_account/owner/staff_details", {state:i})}  style={{cursor:'pointer', textDecoration:'underline'}} class="user_dashboard_listed">
              View Details
            </div>
