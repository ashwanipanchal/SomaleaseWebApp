...
function SalePropertyHome() {
	...
	const getProperies = async() => {
		...
		if(res.status){
			setProperties(res.sale_propertie);
		}
	}
  			...
  			<div class="container">
									...
									<div class="listing-short-detail-wrap">
										<div class="listing-short-detail">
											<div class="d-flex align-items-center">
												<span class="label bg-light-success text-success prt-type me-2">For {item?.property_available == "2" ? "Sale" : "Rent"}</span><span class="label bg-light-purple text-purple property-cats">{item?.property_type}</span>
											</div>
  				...
  				<div class="row align-items-center justify-content-center">
  					<div class="col-lg-12 col-md-12 col-sm-12 text-center mt-5">
  						<button onClick={() => navigate("/all_properties/sales", {state:properties})} class="btn btn-primary px-md-5 rounded">Browse More Properties</button>
  					</div>
  				</div>
...
export default SalePropertyHome