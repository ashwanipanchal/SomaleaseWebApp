  						...
  						<div class="col-lg-6 col-md-6">
  							<div class="footer-widget">
  								<a class="nav-footer-logo">
									...
									{/* <h5 class="fs-2 fw-bold text-light ms-1 my-0">Somalease</h5> */}
  								</a>
  								<div class="footer-add">
									<p style={{fontSize:18}}>Head Office</p>
  									<p>Nairobi Office:58 Burhan Estate, Muratina Road, Eastleigh 00610</p>
  									<p>+254 (0) 703474747</p>
  									<p>info@somalease.com</p>
  								</div>
  								<div class="footer-add mt-10">
									<p style={{fontSize:18}}>Mogadishu Office</p>
  									<p>3rd Floor Suite 9 Aaran Plaza Taleex Street, Hodan District, Mogadishu</p>
  									<p>+252 (0) 611113666</p>
  									<p>info@somalease.com</p>
  								</div>
