...
function RentPropertyHome() {
	const navigate = useNavigate();
	const { login1, otp_verify, home_Properties } = useAuth();
	...
	const getProperies = async() => {
		...
		if(res.status){
			setProperties(res.rent_propertie);
		}
	}
...
<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
  							...
  							<div class="listing-img-wrapper p-3">
  								<div class="list-img-slide position-relative">
									  ...
									  {/* <Slider {...settings}>
										...
										{item.propertie_image?.map((i) => (
									  		<div><a href="single-property-1.html"><img style={{height:240}} src={i?.gallery_image} class="img-fluid" alt="" /></a></div>
										))}
									</Slider> */}
									<div><a><img style={{height:240}} src={item.propertie_image[0]?.gallery_image} class="img-fluid" alt="" /></a></div>
  										{/* <div><a href="single-property-1.html"><img style={{height:240}} src={item.propertie_image[0]?.gallery_image} class="img-fluid" alt="" /></a></div> */}
  							...
  							<div class="listing-caption-wrapper px-3">
  									...
  									<div class="listing-short-detail-wrap">
  										<div class="listing-short-detail">
  											<div class="d-flex align-items-center">
  												<span class="label bg-light-success text-success prt-type me-2">For Rent</span><span class="label bg-light-purple text-purple property-cats">{item?.property_type}</span>
  											</div>
  								...
  								<div class="listing-detail-footer d-flex align-items-center justify-content-between py-4">
  									<div class="listing-short-detail-flex">
  										<h6 class="listing-card-info-price m-0">{item.currency}{item.expected_rent}/Month</h6>
  									</div>
  									<div style={{cursor:'pointer'}} onClick={() => navigate(`/property_details/${item.user_id}/${item.id}`)} class="footer-flex">
  										<a class="prt-view">
  				...
  				<div class="row align-items-center justify-content-center">
  					<div class="col-lg-12 col-md-12 col-sm-12 text-center mt-5">
  						<button onClick={() => navigate("/all_properties/rent", {state:properties})} class="btn btn-primary px-md-5 rounded">Browse More Properties</button>
  					</div>
  				</div>
...
export default RentPropertyHome